...
const TYPES_LIST: QuizType[] = Array.isArray(VALID_TYPES) ? (VALID_TYPES as unknown as QuizType[]) : ['mc', 'ox', 'short'];
...
export default function QuizOptionsModal({ termId, onClose }: Props) {
    ...
    const typeCounts = statsData && 'counts' in statsData ? statsData.counts as Record<string, number> : { mc: 0, ox: 0, short: 0 };
    ...
    return (
        <ModalWrapper titleId="quiz-options-title" onClose={onClose} dialogRef={dialogRef} closing={closing}>
            <div ref={dialogRef}>                <div className="sticky top-0 z-20 bg-gradient-to-r from-[var(--color-brand)]/10 via-[var(--color-brand)]/5 to-[var(--color-brand)]/10 px-8 py-6 border-b border-border/30 rounded-t-2xl backdrop-blur-sm">
                ...
                <div className="p-8 space-y-8">
                    ...
                    </div>                    <div className="space-y-4">                        <h3 className="text-lg font-semibold text-foreground flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">                        <div className="space-y-4">
                        <h3 className="text-lg font-semibold text-foreground flex items-center gap-2">                            <div className="p-1.5 bg-[var(--color-brand)]/10 rounded-lg">
