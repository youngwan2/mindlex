            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">마인드렉스란?</h2>
                        <p className="text-gray-600 dark:text-gray-300 text-lg">정신건강에 대한 올바른 이해를 돕는 교육 플랫폼입니다</p>
                    </div>

                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">우리의 미션</h3>
                            <div className="space-y-4">
                                <div className="flex items-start space-x-3">
                                    <div className="w-6 h-6 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                                        <BookOpen className="h-3 w-3 text-blue-600 dark:text-blue-200" />
                                    </div>
                                    <div>
                                        <h4 className="font-medium text-gray-900 dark:text-white">쉬운 설명</h4>
                                ...
                                <div className="flex items-start space-x-3">
                                    <div className="w-6 h-6 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                                        <Play className="h-3 w-3 text-green-600 dark:text-green-200" />
                                    </div>
                                    <div>
                                        <h4 className="font-medium text-gray-900 dark:text-white">재미있는 학습</h4>
                                ...
                                <div className="flex items-start space-x-3">
                                    <div className="w-6 h-6 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                                        <Heart className="h-3 w-3 text-purple-600 dark:text-purple-200" />
                                    </div>
                                    <div>
                                        <h4 className="font-medium text-gray-900 dark:text-white">정신건강 인식 개선</h4>
                                        <p className="text-gray-600 dark:text-gray-300 text-sm">올바른 정보로 편견을 없애고 이해를 높입니다</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-neutral-900 dark:to-neutral-800 rounded-2xl p-8">
                            <div className="text-center">
                                <Brain className="h-16 w-16 text-blue-600 dark:text-blue-200 mx-auto mb-4" />
                                <h4 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">전문가 검증</h4>
