...
export default function TermHeader({ onSubmit, isLoading }: TermHeaderProps) {
    return (
            ...
            <div className="w-full min-h-[80px] max-w-[1400px] mx-auto px-4 py-6">
                <div className="flex md:items-center items-start justify-between gap-4 md:flex-row flex-col">
                    ...
                    >
                        ...
                        <Input disabled={isLoading ? true : false} type="search" name="search" className="pl-10" placeholder="용어명, 영문명, 설명으로 검색..." />
                    </form>
                </div>
            </div>
        </div>
